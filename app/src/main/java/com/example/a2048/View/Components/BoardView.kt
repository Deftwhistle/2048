package com.example.a2048.View.Components
...
import com.example.a2048.View.Utils.TextViewAdapter
...
class BoardView(
    ...
    init {
        ...
        this.grid = GridView(context,).apply {
            ...
            clipToPadding = false
            adapter = adapterList;
            background = ContextCompat.getDrawable(context, com.example.a2048.R.drawable.border);
